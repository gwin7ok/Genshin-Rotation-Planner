import { CharacterConfig, ElementType, BuffDefinition } from '../types/genshin';
...
const RAW_CURATED_ROSTER: CharacterConfig[] = [
  {
    ...
    availableActions: [
      ...
      { id: 'raiden_q', name: '元素爆発: 奥義・夢想の一心', shortName: 'Q', type: 'burst', defaultDuration: 1.8, startsBurstCooldown: true, energyCost: 90, triggersBuffIds: ['raiden_burst_state'], description: '無想の一太刀を発動し夢想の一心状態に入る(7秒)' },
  ...
  },
  {
    ...
    color: '#ef4444',
    accentColor: '#f87171',
    skillCooldown: 4.0, // 4s with talent 1 in burst: 2s
    burstCooldown: 15.0,
    burstEnergyCost: 60,
    skillParticles: 2.2,
    energyRecharge: 220,
    ...
    constellation: 5,
    availableActions: [
      { id: 'bennett_e', name: '元素スキル: 情熱過剰久遠 (一押し)', shortName: 'E', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, particlesGenerated: 2.2, description: '炎粒子を2〜3個生成 (CT:4.0s)' },
      { id: 'bennett_q', name: '元素爆発: 美冒険の輝き', shortName: 'Q', type: 'burst', defaultDuration: 1.3, startsBurstCooldown: true, energyCost: 60, triggersBuffIds: ['bennett_q_field', 'noblesse_4p'], description: '鼓舞エリア生成(12s): 自身の基礎攻撃力参照の特大攻撃力加算+高頻度回復' },
      { id: 'bennett_e_burst', name: '元素スキル (爆発エリア内CT短縮)', shortName: 'E (短縮)', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, customSkillCT: 2.0, particlesGenerated: 2.2, description: '鼓舞エリア内ではCTが2秒に半減' },
  ...
  },
  {
    ...
    burstCooldown: 20.0,
    burstEnergyCost: 80,
    skillParticles: 4.0, // over 4 breaths
    energyRecharge: 210,
    weaponName: '漁獲 / 草薙の稲光',
    artifactSetName: '絶縁の旗印 4セット',
    constellation: 4,
    availableActions: [
      { id: 'xiangling_q', name: '元素爆発: 旋火輪 (4凸14秒)', shortName: 'Q', type: 'burst', defaultDuration: 1.3, startsBurstCooldown: true, energyCost: 80, triggersBuffIds: ['xiangling_pyronado'], description: '超強力な持続炎追撃。発動時の攻撃力・ダメバフをスナップショット(14s)' },
  ...
  },
  {
    ...
    constellation: 6,
    availableActions: [
      { id: 'xingqiu_q', name: '元素爆発: 古華剣・裁雨留虹', shortName: 'Q', type: 'burst', defaultDuration: 1.4, startsBurstCooldown: true, energyCost: 80, triggersBuffIds: ['xingqiu_raincutter'], description: '剣雨による追撃(15〜18s)。高頻度水付着と中断耐性・被ダメ軽減' },
      { id: 'xingqiu_e', name: '元素スキル: 古華剣・画雨籠山', shortName: 'E', type: 'skill', defaultDuration: 1.1, startsSkillCooldown: true, particlesGenerated: 5.0, description: '2連撃水ダメージ＋水粒子5個生成 (CT: 21.0s)' },
      { id: 'xingqiu_e2', name: '元素スキル (祭礼リセット2回目)', shortName: 'E (祭礼)', type: 'skill_reset', defaultDuration: 1.0, startsSkillCooldown: true, particlesGenerated: 5.0, description: '祭礼の剣効果で即座にもう一度Eを撃ち合計水粒子10個を回収' },
  ...
  },
  {
    ...
    constellation: 0,
    availableActions: [
      { id: 'yelan_q', name: '元素爆発: 淵曜の玲瓏', shortName: 'Q', type: 'burst', defaultDuration: 1.4, startsBurstCooldown: true, energyCost: 70, triggersBuffIds: ['yelan_q_buff'], description: '玄擲玲瓏展開(15s): 通常攻撃に連動して水追撃。時間経過で出場キャラの与ダメ最大+50%UP' },
      { id: 'yelan_e', name: '元素スキル: 幽奇の絡繰り針', shortName: 'E', type: 'skill', defaultDuration: 0.9, startsSkillCooldown: true, particlesGenerated: 4.0, description: '疾走して敵を縛り水ダメージ＋水粒子4個生成 (CT: 10.0s)' },
  ...
  },
  {
    ...
    availableActions: [
      ...
      { id: 'hutao_burst', name: '元素爆発: 安神秘法', shortName: 'Q', type: 'burst', defaultDuration: 1.7, startsBurstCooldown: true, energyCost: 60, description: '広範囲に強力な炎超大ダメージ＋自己回復' },
    ]
  },
  {
    id: 'zhongli',
    ...
    availableActions: [
      ...
      { id: 'zhongli_q', name: '元素爆発: 天星', shortName: 'Q', type: 'burst', defaultDuration: 2.1, startsBurstCooldown: true, energyCost: 40, description: '巨大隕石落下で石化(3.5s〜4s)付与 (CT: 12.0s)' },
    ]
  },
  {
    id: 'kazuha',
    ...
    color: '#0d9488',
    accentColor: '#2dd4bf',
    skillCooldown: 6.0, // tap 6s, hold 9s
    burstCooldown: 15.0,
    burstEnergyCost: 60,
    skillParticles: 3.5,
    energyRecharge: 160,
    ...
    constellation: 0,
    availableActions: [
      { id: 'kazuha_hold_e_plunge', name: '長押しスキル＋乱れ嵐斬 (落下)', shortName: '長E+PA', type: 'skill_hold', defaultDuration: 1.9, startsSkillCooldown: true, customSkillCT: 9.0, particlesGenerated: 4.0, triggersBuffIds: ['kazuha_buff', 'vv_shred'], description: '広範囲集敵＋拡散による元素ダメバフ(8s)＋翠緑耐性-40%(10s)' },
      { id: 'kazuha_tap_e_plunge', name: '一押しスキル＋乱れ嵐斬 (落下)', shortName: '短E+PA', type: 'skill', defaultDuration: 1.4, startsSkillCooldown: true, customSkillCT: 6.0, particlesGenerated: 3.0, triggersBuffIds: ['kazuha_buff', 'vv_shred'], description: '素早い集敵＋拡散バフ・デバフ付与' },
      { id: 'kazuha_q', name: '元素爆発: 万葉の一刀', shortName: 'Q', type: 'burst', defaultDuration: 1.6, startsBurstCooldown: true, energyCost: 60, triggersBuffIds: ['kazuha_burst_slash'], description: '流風秋野を展開(8s)。定期的に拡散を起こし継続バフ更新' },
    ]
  },
  {
    id: 'childe',
    ...
    constellation: 0,
    availableActions: [
      { id: 'childe_ranged_q', name: '元素爆発 (弓モード・魔弾一閃)', shortName: '弓Q', type: 'burst', defaultDuration: 1.3, startsBurstCooldown: true, energyCost: 40, description: '発動時エネルギーが20還元されるため実質40コストで高火力蒸発' },
      ...
      { id: 'childe_melee_burst', name: '元素爆発 (近接・尽滅閃)', shortName: '近Q', type: 'burst', defaultDuration: 1.8, startsBurstCooldown: true, energyCost: 60, description: '近接超特大倍率水ダメージ' },
  ...
  },
  {
    ...
    availableActions: [
      ...
      { id: 'furina_q', name: '元素爆発: 万民の歓呼', shortName: 'Q', type: 'burst', defaultDuration: 1.3, startsBurstCooldown: true, energyCost: 60, triggersBuffIds: ['furina_fanfare'], description: 'もろびとこぞりて(18s)。テンション蓄積に応じて味方全員に最大+75%の全ダメバフ' },
  ...
  },
  {
    ...
    constellation: 1,
    availableActions: [
      { id: 'neuv_q', name: '元素爆発: 潮よ、我が帰還を祝え', shortName: 'Q', type: 'burst', defaultDuration: 1.9, startsBurstCooldown: true, energyCost: 70, description: '大ダメージ＋源水の雫6個生成' },
      { id: 'neuv_e', name: '元素スキル: 涙よ、我が清算を濯げ', shortName: 'E', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, particlesGenerated: 4.0, description: '水ダメ＋源水の雫3個生成 (CT: 12.0s)' },
  ...
  },
  {
    ...
    color: '#059669',
    accentColor: '#34d399',
    skillCooldown: 6.0, // hold 6s, tap 5s
    burstCooldown: 13.5,
    burstEnergyCost: 50,
    skillParticles: 3.0,
    energyRecharge: 130,
    ...
    constellation: 2,
    availableActions: [
      { id: 'nahida_hold_e', name: '元素スキル: 所聞遍計 (長押しスキャン)', shortName: '長押しE', type: 'skill_hold', defaultDuration: 1.2, startsSkillCooldown: true, customSkillCT: 6.0, particlesGenerated: 3.0, triggersBuffIds: ['nahida_tri_karma', 'deepwood_4p'], description: '敵8体に滅浄三業マーク付与(25s)。草元素反応に連動して追撃＋草耐性-30%' },
      { id: 'nahida_q', name: '元素爆発: 心景幻成 (摩耶の宮殿)', shortName: 'Q', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 50, triggersBuffIds: ['nahida_shrine_buff'], description: '摩耶の宮殿展開(15s): 出場キャラの元素熟知最大+250UP' },
  ...
  },
  {
    ...
    constellation: 0,
    availableActions: [
      { id: 'alhaitham_q', name: '元素爆発: 殊境・顕象結縛', shortName: 'Q', type: 'burst', defaultDuration: 1.8, startsBurstCooldown: true, energyCost: 70, description: '琢光鏡0枚時発動で2秒後に鏡3枚獲得' },
      ...
      { id: 'alhaitham_infusion_combo', name: '3鏡コンボ (通常攻撃+追撃)', shortName: '3鏡コンボ', type: 'combo', defaultDuration: 4.0, description: '琢光鏡3枚状態での高頻度草追撃' },
  ...
  },
  {
    ...
    availableActions: [
      ...
      { id: 'shinobu_q', name: '元素爆発: 御詠鳴神刈山祭', shortName: 'Q', type: 'burst', defaultDuration: 1.4, startsBurstCooldown: true, energyCost: 60, description: '雷範囲結界生成' },
    ]
  },
  {
    id: 'arlecchino',
    ...
    constellation: 0,
    availableActions: [
      { id: 'arlecchino_e', name: '元素スキル: 万象の灰燼', shortName: 'E', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, particlesGenerated: 5.0, description: '突進して血償の勒を付与 (CT: 30.0s)' },
      ...
      { id: 'arlecchino_q', name: '元素爆発: 昇りゆく厄月', shortName: 'Q', type: 'burst', defaultDuration: 1.6, startsBurstCooldown: true, energyCost: 60, description: '範囲炎ダメージ＋スキルCTリセット＋自己回復' },
    ]
  },
  {
    id: 'clorinde',
    ...
    availableActions: [
      ...
      { id: 'clorinde_q', name: '元素爆発: 残光を刈り取る夜', shortName: 'Q', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 60, description: '5連雷撃＋命の契約大量獲得' },
    ]
  },
  {
    id: 'navia',
    ...
    constellation: 0,
    availableActions: [
      { id: 'navia_e', name: '元素スキル: セレモニアル・クリスタルショット', shortName: 'E射撃', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, particlesGenerated: 3.5, description: '結晶破片を消費して超絶散弾大ダメージ' },
      { id: 'navia_q', name: '元素爆発: 金のバラに捧げる祝砲', shortName: 'Q祝砲', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 60, description: '砲撃陣展開(12s): 定期的に結晶破片自動充填' },
  ...
  },
  {
    ...
    constellation: 0,
    availableActions: [
      { id: 'xianyun_e_plunge', name: '元素スキル: 朝鶴の舞 (3段跳躍＋波浪)', shortName: 'EEE+PA', type: 'skill', defaultDuration: 1.5, startsSkillCooldown: true, particlesGenerated: 5.0, description: '広範囲風ダメージ＋翠緑拡散' },
      { id: 'xianyun_q', name: '元素爆発: 夕鶴の導き', shortName: 'Q', type: 'burst', defaultDuration: 1.4, startsBurstCooldown: true, energyCost: 70, description: '竹星召喚: 全体回復＋ジャンプ力大幅UP(落下攻撃補助8回)' },
    ]
  },
  {
    id: 'fischl',
    ...
    availableActions: [
      ...
      { id: 'fischl_q', name: '元素爆発: 漆黒の翼 (オズ更新)', shortName: 'Qオズ', type: 'burst', defaultDuration: 1.0, startsBurstCooldown: true, energyCost: 60, description: 'オズの滞留時間を更新・再配置' },
    ]
  },
  {
    id: 'sucrose',
    ...
    constellation: 6,
    availableActions: [
      { id: 'sucrose_e', name: '元素スキル: 風霊作成・陸参〇八', shortName: 'E', type: 'skill', defaultDuration: 0.9, startsSkillCooldown: true, particlesGenerated: 4.0, description: '集敵風ダメージ＋味方に元素熟知バフ＋翠緑耐性ダウン' },
      { id: 'sucrose_q', name: '元素爆発: 禁術・風霊作成・伍〇八', shortName: 'Q', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 80, description: '巨大風霊召喚(6s): 継続集敵＆元素変化ダメバフ' },
    ]
  },
  {
    id: 'ganyu',
    ...
    availableActions: [
      ...
      { id: 'ganyu_q', name: '元素爆発: 降魔の氷蓮', shortName: 'Q', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 60, description: '降魔の氷蓮展開(15s): 氷柱継続落下＋氷ダメバフ+20%' },
      { id: 'ganyu_e', name: '元素スキル: 麒麟の道', shortName: 'E', type: 'skill', defaultDuration: 0.7, startsSkillCooldown: true, particlesGenerated: 2.0, description: '後方後退＋デコイ氷蓮設置' },
    ]
  },
  {
    id: 'ayaka',
    ...
    availableActions: [
      ...
      { id: 'ayaka_q', name: '元素爆発: 神里流・霜滅', shortName: 'Q', type: 'burst', defaultDuration: 1.8, startsBurstCooldown: true, energyCost: 80, description: '前進する猛烈な氷竜巻(5s20ヒット)超高火力' },
      { id: 'ayaka_e', name: '元素スキル: 神里流・氷華', shortName: 'E', type: 'skill', defaultDuration: 0.8, startsSkillCooldown: true, particlesGenerated: 4.5, description: '周囲氷咲き出し＋通常重撃バフ' },
  ...
  },
  {
    ...
    constellation: 0,
    availableActions: [
      { id: 'mualani_e', name: '元素スキル: サメサメスライディング', shortName: 'E波乗り', type: 'skill', defaultDuration: 1.0, startsSkillCooldown: true, description: '夜魂の加護・サメボード突入' },
      { id: 'mualani_bite', name: 'サメサメバイト (3層累積時超火力蒸発)', shortName: 'サメバイト', type: 'charged', defaultDuration: 0.8, description: '標的3層蓄積時の超絶一撃水ダメージ' },
      { id: 'mualani_q', name: '元素爆発: 爆裂サメミサイル', shortName: 'Q', type: 'burst', defaultDuration: 1.5, startsBurstCooldown: true, energyCost: 60, description: '巨大サメミサイル投射' },
    ]
  },
  {
    id: 'kinich',
    ...
    availableActions: [
      ...
      { id: 'kinich_q', name: '元素爆発: 聖竜アハウ召喚', shortName: 'Q', type: 'burst', defaultDuration: 1.6, startsBurstCooldown: true, energyCost: 70, description: 'アハウ降臨ブレス継続射出' },
    ]
  },
  {
    id: 'xilonen',
    ...
    availableActions: [
      ...
      { id: 'xilonen_q', name: '元素爆発: DJミキサーDJビート', shortName: 'Q', type: 'burst', defaultDuration: 1.4, startsBurstCooldown: true, energyCost: 60, description: '全体回復＋岩・元素ダメージ' },
    ]
  }
];
...
export const ALL_CHARACTERS_ROSTER: CharacterConfig[] = (() => {
  ...
  // 1. Populate all characters from genshin-db + gcsim master dataset
  ...
  // 2. Merge hand-curated roster overrides (preserving custom buffs, combo presets, weapon names, constellations)
