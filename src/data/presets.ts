...
export const ROTATION_PRESETS: PartyPreset[] = [
  {
    ...
    stints: [
      ...
      },
      {
        id: 'stint_5',
        characterId: 'raiden',
        note: '全バフが乗った状態で夢想の一太刀＋全員へ25エネルギー供給',
        actions: [
  ...
  },
  {
    ...
    stints: [
      ...
      },
      {
        id: 'stint_ht_4',
        characterId: 'hutao',
        note: '冥蝶の舞発動！夜蘭の最大ダメバフ＋蒸発重撃連打＋フィニッシュ爆発',
        actions: [
  ...
  },
  {
    ...
    stints: [
      ...
      },
      {
        id: 'stint_intl_3',
        characterId: 'kazuha',
        note: '敵の水＋自身の炎で水・炎の二重拡散！全元素ダメバフ+40%＆耐性-40%',
        actions: [
      ...
      },
      {
        id: 'stint_intl_5',
        characterId: 'childe',
        note: '弓爆発で大ダメージ蒸発後に近接連撃で香菱を全段蒸発させる',
        actions: [
  ...
  },
  {
    ...
    stints: [
      ...
      },
      {
        id: 'stint_neuv_3',
        characterId: 'kazuha',
        note: 'サロンメンバーの水攻撃を万葉で拡散 (翠緑水耐性-40% & 水ダメバフ+40%)',
        actions: [
      ...
      },
      {
        ...
        note: '爆発＋スキルで雫9個生成し、超強化重撃ビーム2連射！',
        actions: [
    ...
    stints: [
      {
        id: 'stint_haitham_1',
        characterId: 'nahida',
        note: '長押しEで全敵マーク＋摩耶の宮殿で熟知+250バフ',
        actions: [
      ...
      },
      {
        ...
        note: '爆発で鏡3枚獲得 → 3段光幕射出 → 重撃で鏡更新のフルコンボ',
        actions: [
